	...
	<body class="stretched">
		...
		<div id="wrapper" class="clearfix">
				...
				<div id="header-wrap">
					<div class="container">
						<div class="header-row">
							...
							============================================= -->
							<div id="logo">
								<a href="index.html" class="standard-logo" data-dark-logo="{{ asset('assets/app/images/micontabilidad-logo-dark.png') }}"><img src="{{ asset('assets/app/images/micontabilidad-logo.png') }}" alt="Canvas Logo"></a>
								<a href="index.html" class="retina-logo" data-dark-logo="{{ asset('assets/app/images/micontabilidad-logo-dark@2x.png') }}"><img src="{{ asset('assets/app/images/micontabilidad-logo@2x.png') }}" alt="Canvas Logo"></a>
							</div><!-- #logo end -->
							...
							<div class="header-misc">
								...
								<div id="top-cart" class="header-misc-icon d-none d-sm-block">
									...
									<div class="top-cart-content">
										<div class="top-cart-title"><h4>Shopping Cart</h4></div>

										<div class="top-cart-items">
											<div class="top-cart-item">
												<div class="top-cart-item-image">
													<a href="#"><img src="{{ asset('assets/app/images/shop/small/1.jpg') }}" alt="Blue Round-Neck Tshirt" /></a>
												</div>
											...
											<div class="top-cart-item">
												<div class="top-cart-item-image">
													<a href="#"><img src="{{ asset('assets/app/images/shop/small/6.jpg') }}" alt="Light Blue Denim Dress" /></a>
												</div>
			...
			<section id="slider" class="slider-element slider-parallax min-vh-60 min-vh-md-100">
				<div class="slider-inner" style="background: url('{{ asset('assets/app/images/appshowcase/1.jpg') }}'); background-size: cover;">

					<div class="container">
						<img src="{{ asset('assets/app/images/appshowcase/slider-iphone.png') }}" alt="Image" class="d-none d-lg-block" style="position: absolute; left: 0; bottom: 0;">
